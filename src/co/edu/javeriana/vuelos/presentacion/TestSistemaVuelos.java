...
public class TestSistemaVuelos {
	...
	public static void main(String[] args) {
		...
		while (ope!=12){
			...
			System.out.println("2: ingresar aerol�neas y vuelos planeados del sistema");
			System.out.println("3: ingresar agentes del sistema");
			System.out.println("4: agregar un vuelo espec�fico para un vuelo planeado");
			System.out.println("5: mostrar aerol�neas, vuelos planeados y vuelos espec�ficos del sistema");
			...
			System.out.println("10: tiquete electr�nico: para un itinerario comprado mostrar su valor,sus trayectos, las sillas reservadas y los pasajeros asociados");
			System.out.println("11: reporte vuelos espec�ficos: dado el nombre de una ciudad de origen y el de una ciudad destino");
